...
/**
 * In this part we introduce stream computation. We'll implement a very simple Storm bolt which will raise an alert
 * if a driver exceeds 5 violations.
 */
public class Lab {
  ...
  public static void main(String args[]) {
    ...
    builder.setBolt("monitoring_bolt",
        new com.hortonworks.lab.TruckEventRuleBolt(), boltCount)
        .fieldsGrouping("kafkaSpout", new Fields("driverId"));


    // IMPORTANT: create topology before submitting to cluster
    StormTopology topology = builder.createTopology();
    stormLocalCluster.submitTopology("part3", stormLocalCluster.getStormConf(), topology);
