...
public class SparkPredictionBolt implements IRichBolt {
  ...
  private static final Map<Integer, _driverRow> driverTable = new HashMap<Integer, _driverRow>();
  private static final Map<Integer, Map<Integer, _weekData>> timesheetTable = new HashMap<Integer, Map<Integer, _weekData>>();
